    ...
    options: [
      {
        ...
        description: 'Ship fast, capture market. Higher revenue but increased risk.',
        effects: [
          { label: '+30% token revenue', type: 'positive' },
          { label: 'Market edge decays 20% slower', type: 'positive' },
        ],
        alignmentNote: 'Deploying without thorough safety review increases risk of incidents',
        bestWhen: 'Market edge declining, need revenue boost',
      },
      {
        id: 'careful_validation',
        name: 'Careful Validation',
        description: 'Thorough validation delays deployment but catches failure modes early.',
        effects: [
          { label: '-30% incident rate (Arc 2)', type: 'positive' },
        ],
        alignmentNote: 'Thorough validation delays deployment but catches failure modes early',
        bestWhen: 'Strong market position, playing for alignment/safety',
      },
    ],
  },
];
